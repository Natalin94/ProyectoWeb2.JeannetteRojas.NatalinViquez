...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update of Team</h1>
                            ...
                            <div class="row" >
                                <div class="col-lg-6">
                                    <form role="form" id="form1">
                                        ...
                                        <div class="form-group">
                                            <label>Points</label>
                                            <input class="form-control" placeholder="Points" id="points">
                                        </div>
                                        <div class="form-group">
                                            <label>Flag</label>
                                            <input class="form-control" placeholder="URL" id="flag">
                                        </div>                                   
                                    
                                        <button id="bAgregar" href='actualizarEquipos.html' onclick="actualizarEquipos()" class="btn btn-default">Update Team</button> 
